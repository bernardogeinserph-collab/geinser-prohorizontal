...
<div style={{padding:'18px 18px 14px',borderBottom:'1px solid rgba(255,255,255,0.12)'}}><div style={{display:'flex',alignItems:'center',gap:12}}><div style={{background:GB,borderRadius:12,width:46,height:46,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,boxShadow:'0 2px 8px rgba(0,0,0,0.3)'}}><span style={{fontSize:26,fontWeight:900,color:GG,lineHeight:1}}>G</span></div><div><div style={{fontSize:17,fontWeight:900,color:'#fff',letterSpacing:'1.5px',lineHeight:1.1}}>GEINSER</div><div style={{fontSize:9,fontWeight:700,color:GG,letterSpacing:'3px',marginTop:3}}>PROHORIZONTAL</div></div></div></div>
...
<div style={{display:'flex',alignItems:'center',gap:8}}><div style={{background:GB,borderRadius:9,width:34,height:34,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}><span style={{fontSize:20,fontWeight:900,color:GG,lineHeight:1}}>G</span></div><div><div style={{fontSize:13,fontWeight:900,color:'#fff',letterSpacing:'1px',lineHeight:1.1}}>GEINSER</div><div style={{fontSize:7.5,fontWeight:700,color:GG,letterSpacing:'2.5px',marginTop:2}}>PROHORIZONTAL</div></div></div>
</div>
